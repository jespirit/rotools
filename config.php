...
$CONFIG['rag_user']		=	'eathena';		// SQL Ragnarok User
$CONFIG['rag_pass']		=	'eathena';		// SQL Ragnarok Password
$CONFIG['rag_db']			=	'eathena';		// SQL Ragnarok Database name
$CONFIG['log_db']			=	'log';		// SQL Ragnarok Log Database name

$CONFIG['cp_serv']		=	'localhost';	// SQL CP Host
$CONFIG['cp_user']		=	'eathena';		// SQL CP User
$CONFIG['cp_pass']		=	'eathena';		// SQL CP Password
$CONFIG['cp_db']			=	'cerescp';			// SQL CP Database name
...
date_default_timezone_set('UTC');		// game server Timezone (useful if your webserver's timezone is different than game server).
...
$CONFIG['max_chars']		=	'9';			// Max amount of chars (set this to what's set for MAX_CHARS in your emulators src/common/mmo.h)
...
$config['servermode'] = '1'; // For use the right query with rA or eA 

//About Information
$CONFIG['classlist_show']	=	'1';			// Show the class list on about.php? (disable = 0, enable = 1)
$CONFIG['classlist_hide_zero']	=	'0';			// Hide class entries with zero amount? (disable = 1, enable = 0)

//Mail
$CONFIG['smtp_server']		=	'54.187.100.97';	// the smtp server, the cp will use to send mails
